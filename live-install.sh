...
# Interactive ZyNixOS installer for ZyNixOS flake
...
# Host selection
info "ZyNixOS Configuration Host Selection"
...
# Copy flake to ~/ZyNixOS
info "Copying flake to /home/$username/ZyNixOS..."
mkdir -p "/mnt/home/$username/ZyNixOS"
cp -r ./ "/mnt/home/$username/ZyNixOS/" || {
