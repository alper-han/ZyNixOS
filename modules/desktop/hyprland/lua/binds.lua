...
for _, binding in ipairs({
  ...
  hl.bind(binding[1], run(binding[2]), { repeating = true, locked = true })
end

hl.bind("XF86MonBrightnessDown", hl.dsp.global("caelestia:brightnessDown"), { repeating = true, locked = true })
hl.bind("XF86MonBrightnessUp", hl.dsp.global("caelestia:brightnessUp"), { repeating = true, locked = true })
...
hl.bind("CONTROL + ESCAPE", run(shell_toggle))

hl.bind(mainMod .. " + Return", run(term))
hl.bind(mainMod .. " + T", run(term))
hl.bind(mainMod .. " + E", run(file_manager))
...
hl.bind(mainMod .. " + ALT + G", run(caelestia .. " shell gameMode toggle"))
...
hl.bind("XF86AudioMicMute", run("pamixer --default-source -t"), { locked = true })
hl.bind(mainMod .. " + M", run("pamixer --default-source -t"))
hl.bind("XF86AudioMute", run("pamixer -t"), { locked = true })
